  ...
  return (
    <nav className="p-5 w-full">
      <div className="flex justify-between items-center">
        <span className=" text-2xl text-black font-bold">Dashboard </span>
        <div className="flex justify-start items-center px-4 py-2 bg-white rounded-xl">
          <input
            type="text"
            className="text-sm text-gray-500 w-36 outline-none"
            placeholder="Search..."
          />
          <svg
            width="13"
